...
void HAL_LPTIM_MspInit(LPTIM_HandleTypeDef* lptimHandle)
{
  ...
  */
    ...
    PB5     ------> LPTIM1_IN1
    */
    GPIO_InitStruct.Pin = Tach_RadFan_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_LPTIM1;
    HAL_GPIO_Init(Tach_RadFan_GPIO_Port, &GPIO_InitStruct);
  ...
  */
    ...
    PB1     ------> LPTIM2_IN1
    */
    GPIO_InitStruct.Pin = Tach_FlowRate_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF14_LPTIM2;
    HAL_GPIO_Init(Tach_FlowRate_GPIO_Port, &GPIO_InitStruct);
...
void HAL_LPTIM_MspDeInit(LPTIM_HandleTypeDef* lptimHandle)
{
  ...
  /* USER CODE END LPTIM1_MspDeInit 0 */
    ...
    PB5     ------> LPTIM1_IN1
    */
    HAL_GPIO_DeInit(Tach_RadFan_GPIO_Port, Tach_RadFan_Pin);
  ...
  /* USER CODE END LPTIM2_MspDeInit 0 */
    ...
    PB1     ------> LPTIM2_IN1
    */
    HAL_GPIO_DeInit(Tach_FlowRate_GPIO_Port, Tach_FlowRate_Pin);
